    ...
    >
      {slides.map((slide, i) => (
        <span
          ...
          className={cn(
            "absolute left-1/2 top-1/2 inline-flex items-center gap-2 whitespace-nowrap font-body text-pill font-medium transition-[opacity,transform] duration-500 ease-out",
